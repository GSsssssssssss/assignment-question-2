...
function highlightHTMLContent(htmlContent, plainText, plainTextPositions) {
  // Create an array to hold the modified content
  let modifiedContent = [];
  ...
  plainTextPositions.forEach((plainTextPosition) => {
    ...
    // Add the content before the current position to the modified content array
    modifiedContent.push(htmlContent.slice(lastIndex, startHTMLPosition));
    // Add the highlighted content to the modified content array
